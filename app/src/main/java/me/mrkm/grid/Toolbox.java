...
//            if (pieces[i].enabled) {
//
//                float dx = (width / size) * i + (width / size / 2) - Grid.cellSize * scale * Chunk.size / 2;
//                float dy = screenHeight - height + (height / 2) - Grid.cellSize * scale * Chunk.size / 2;
//
...
//        if (pickUp != null) {
//
//            float dx = touchX - Grid.cellSize * Chunk.size / 2;
//            float dy = touchY - Grid.cellSize * Chunk.size;
//
//            canvas.translate(dx, dy);
//
//            for (int y = 0; y < Chunk.size; y++) {
